...
app.get('/', function (req, res) {
	...
	cmdb._fetch(res.locals, endpointsURL(req)).then(function (endpoints) {
		...
		res.render('index', Object.assign({'pages':number['01','02','03','04','05'], endpoints: endpoints}, req.query));
	}).catch(function (error) {
		res.status(502);
