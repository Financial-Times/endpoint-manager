...
app.post('/manage/:endpointid', function (req, res) {
	...
	if (req.body.systemCode) endpoint.isHealthcheckFor = {system: [{'dataItemID': eq.body.systemCode}]};
...
function endpointController(endpoint) {
	...
	if (endpoint.isHealthcheckFor && endpoint.isHealthcheckFor.system) {
		endpoint.systemCode = endpoint.isHealthcheckFor.system.dataItemID.pop();
	}
